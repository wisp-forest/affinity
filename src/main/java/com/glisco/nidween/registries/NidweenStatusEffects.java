...
public class NidweenStatusEffects {
    ...
    public static final StatusEffect FREEZING = new FreezingStatusEffect(StatusEffectType.HARMFUL, 0x000066);
    ...
    public static void register() {
        ...
        registerPotions(StatusEffects.GLOWING, "glowing", 9600, true, false);
