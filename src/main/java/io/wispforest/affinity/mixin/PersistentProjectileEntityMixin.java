...
public abstract class PersistentProjectileEntityMixin extends Entity {
    ...
    private void setExtraDamage(Entity owner, CallbackInfo ci) {
        ...
        damageComponent.extraDamage = (int) living.getAttributeValue(Registries.ATTRIBUTE.getEntry(AffinityEntityAttributes.EXTRA_ARROW_DAMAGE));
    }

    // TODO: did changing this from a ModifyVariable to ModifyArg change behavior?
    ...
    private float applyExtraDamage(float damage) {
