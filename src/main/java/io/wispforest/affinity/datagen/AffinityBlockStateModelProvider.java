...
public class AffinityBlockStateModelProvider extends FabricModelProvider {
    ...
    public void generateBlockStateModels(BlockStateModelGenerator generator) {
        ...
        this.primitiveState(generator,
                ...
                CREATIVE_AETHUM_FLUX_CACHE, EMERALD_BLOCK, SUNDIAL, BREWING_CAULDRON, WORLD_PIN, CROP_REAPER, AFFINE_INFUSER, VOID_BEACON, FIELD_COHERENCE_MODULATOR
        );
    }
    ...
    public void generateItemModels(ItemModelGenerator generator) {
        this.parentedItem(generator,
                ...
                CREATIVE_AETHUM_FLUX_CACHE, EMERALD_BLOCK, INFUSED_STONE, MATTER_HARVESTING_HEARTH, VOID_BEACON
        );
