...
public class AffinityBlockStateModelProvider extends FabricModelProvider {
    ...
    public void generateBlockStateModels(BlockStateModelGenerator generator) {
        ...
        this.primitiveState(generator,
                ...
                REFINED_RITUAL_SOCLE, SOPHISTICATED_RITUAL_SOCLE, RITUAL_SOCLE_COMPOSER, SPIRIT_INTEGRATION_APPARATUS, ASP_RITE_CORE, ASSEMBLY_AUGMENT, STAFF_PEDESTAL,
                CREATIVE_AETHUM_FLUX_CACHE, EMERALD_BLOCK, SUNDIAL, BREWING_CAULDRON, WORLD_PIN, CROP_REAPER, AFFINE_INFUSER
        );
    }
    ...
    public void generateItemModels(ItemModelGenerator generator) {
        this.parentedItem(generator,
                ...
                CREATIVE_AETHUM_FLUX_CACHE, EMERALD_BLOCK, INFUSED_STONE, MATTER_HARVESTING_HEARTH
        );
