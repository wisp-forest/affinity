...
public class AffinityBlockStateDefinitionProvider extends FabricModelProvider {
    ...
    public void generateBlockStateModels(BlockStateModelGenerator generator) {
        ...
        cubeAllWithParentedItem(generator, PECULIAR_CLUMP, UNFLOWERING_AZALEA_LEAVES, THE_SKY, INVERSION_STONE);
        ...
        simpleStateWithParentedItem(generator, COPPER_PLATED_AETHUM_FLUX_NODE, STONE_BANDED_AETHUM_FLUX_NODE,
                ...
                ASP_RITE_CORE, ASSEMBLY_AUGMENT, STAFF_PEDESTAL, CREATIVE_AETHUM_FLUX_CACHE, EMERALD_BLOCK
        );
    }
    ...
    public void generateItemModels(ItemModelGenerator generator) {
        generated(generator, AZALEA_FLOWERS, AETHUM_FLUX_BOTTLE, AZALEA_BOAT, AZALEA_CHEST_BOAT,
                ...
                SATIATING_POTION, ARCANE_FADE_BUCKET, AETHUM_OVERCHARGER, EMERALD_HELMET, EMERALD_CHESTPLATE,
                EMERALD_LEGGINGS, EMERALD_BOOTS, EMERALD_INGOT, EMERALD_NUGGET, FEATHERWEIGHT_RING
        );
