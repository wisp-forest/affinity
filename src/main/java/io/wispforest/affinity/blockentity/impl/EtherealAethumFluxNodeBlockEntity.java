...
public class EtherealAethumFluxNodeBlockEntity extends AethumNetworkMemberBlockEntity implements InteractableBlockEntity, TickedBlockEntity, Nameable {
    ...
    private static final KeyedEndec<ItemStack> SHARD = MinecraftEndecs.ITEM_STACK.keyed("shard", ItemStack.EMPTY);
    ...
    protected void writeNbt(NbtCompound nbt, RegistryWrapper.WrapperLookup registries) {
        ...
        nbt.putIfNotNull(ctx, CUSTOM_NAME_KEY, this.customName);
        nbt.putIfNotNull(ctx, OWNER_KEY, this.owner);
        nbt.put(GLOBAL_KEY, this.global);
        nbt.put(ctx, SHARD, this.shard);
    }
    ...
    public void readNbt(NbtCompound nbt, RegistryWrapper.WrapperLookup registries) {
        ...
        this.setShardStack(nbt.get(ctx, SHARD));
    }
