...
public class AffinityOwoWhatsThisPlugin implements OwoWhatsThisPlugin {
    ...
    static {
        InformationProvider.REFLECTIVE_BUILDER.register(PotionMixture.ENDEC, PotionMixture.class);
    }
    ...
    public static class Client {
        ...
        public static final InformationProvider.DisplayAdapter<BrewingCauldronData> POTION_MIXTURE = data -> {
            return TexturedProgressBarComponent.ofSprite(
                    Text.translatable(Potion.finishTranslationKey(Optional.of(Registries.POTION.getEntry(data.mixture.basePotion())), Items.POTION.getTranslationKey() + ".effect.")),
                    data.fillLevel,
