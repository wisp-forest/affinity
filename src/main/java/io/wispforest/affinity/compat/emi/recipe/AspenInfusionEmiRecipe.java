...
public class AspenInfusionEmiRecipe extends BasicEmiRecipe {
    ...
    public AspenInfusionEmiRecipe(Identifier id, AspenInfusionRecipe recipe) {
        ...
        this.outputs = List.of(EmiStack.of(this.recipe.getOutput(null)));
    }
    ...
    public void addWidgets(WidgetHolder widgets) {
        ...
        outputContainer.child(adapter.wrap((x, y) -> AffinityEmiPlugin.slot(EmiStack.of(this.recipe.getOutput(null)), x, y).large(true).recipeContext(this)));
