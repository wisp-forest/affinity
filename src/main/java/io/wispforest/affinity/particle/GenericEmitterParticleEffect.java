...
public record GenericEmitterParticleEffect(ParticleEffect effect, Vec3d emitVelocity, int emitInterval, float emitDeviation, int emitterLifetime) implements ParticleEffect {
    ...
    public static final ParticleEffect.Factory<GenericEmitterParticleEffect> FACTORY = new Factory<>() {
        ...
        public GenericEmitterParticleEffect read(ParticleType<GenericEmitterParticleEffect> type, StringReader reader) {
            return new GenericEmitterParticleEffect(ParticleTypes.SMOKE, Vec3d.ZERO, 2, .15f, 20);
        }
