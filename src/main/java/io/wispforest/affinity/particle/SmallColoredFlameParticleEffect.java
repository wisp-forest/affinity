...
public record SmallColoredFlameParticleEffect(int dyeColorId) implements ParticleEffect {
    ...
    public SmallColoredFlameParticleEffect(DyeColor color) {
        this(color.getId());
    }

    public static final Factory<SmallColoredFlameParticleEffect> FACTORY =
            new Factory<>() {
                @Override
                public SmallColoredFlameParticleEffect read(ParticleType<SmallColoredFlameParticleEffect> type, StringReader reader) throws CommandSyntaxException {
                    reader.expect(' ');
                    ...
                    return new SmallColoredFlameParticleEffect(dyeColor);
                }

                @Override
                public SmallColoredFlameParticleEffect read(ParticleType<SmallColoredFlameParticleEffect> type, PacketByteBuf buf) {
                    return new SmallColoredFlameParticleEffect(buf.readByte());
                }
            };
