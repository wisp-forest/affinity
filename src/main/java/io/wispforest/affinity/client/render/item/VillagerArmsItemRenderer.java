...
public class VillagerArmsItemRenderer implements BuiltinItemRendererRegistry.DynamicItemRenderer {
    public static final Identifier NORMIE = new Identifier("textures/entity/villager/villager.png");
    ...
    public void render(ItemStack stack, ModelTransformationMode mode, MatrixStack matrices, VertexConsumerProvider vertexConsumers, int light, int overlay) {
        ...
        renderArms(stack.get(VillagerArmatureBlockEntity.VILLAGER_DATA), matrices, vertexConsumers, light, overlay);
    }
