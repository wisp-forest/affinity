...
public class NimbleStaffHud {
    ...
    public static final Identifier TEXTURE_ID = Affinity.id("textures/gui/sprites/nimble_staff_indicator.png");
    ...
    public static void initialize() {
        Hud.add(COMPONENT_ID, () -> new BaseComponent() {
            ...
            public void draw(OwoUIDrawContext context, int mouseX, int mouseY, float partialTicks, float delta) {
                ...
                context.drawTexture(TEXTURE_ID, this.x, this.y, 0, 0, 3, 19, 3, 19);
