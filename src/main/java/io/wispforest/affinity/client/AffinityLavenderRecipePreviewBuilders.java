...
public class AffinityLavenderRecipePreviewBuilders {
    ...
    public static void initialize() {
        ...
        LavenderBookScreen.registerRecipePreviewBuilder(WISPEN_TESTAMENT_BOOK_ID, AffinityRecipeTypes.ORNAMENT_CARVING, (componentSource, recipeEntry) -> {
            ...
            recipeComponent.childById(ItemListComponent.class, "input").ingredient(recipeEntry.input);
            recipeComponent.childById(ItemComponent.class, "output").stack(recipeEntry.getOutput(null));

            return recipeComponent;
        });

        LavenderBookScreen.registerRecipePreviewBuilder(WISPEN_TESTAMENT_BOOK_ID, AffinityRecipeTypes.ASPEN_INFUSION, (componentSource, recipeInstance) -> {
            int inputSize = 76;
            ...
            root.child(Containers.verticalFlow(Sizing.fixed(40), Sizing.fill(100)).<FlowLayout>configure(container -> {
                ...
                container.child(Containers.stack(Sizing.content(), Sizing.content())
                        ...
                        .child(Components.item(recipeInstance.getOutput(null)).showOverlay(true).setTooltipFromStack(true))
                        .horizontalAlignment(HorizontalAlignment.CENTER).verticalAlignment(VerticalAlignment.CENTER)
        ...
        LavenderBookScreen.registerRecipePreviewBuilder(WISPEN_TESTAMENT_BOOK_ID, AffinityRecipeTypes.SPIRIT_ASSIMILATION, (componentSource, recipeInstance) -> {
            int inputSize = 96;
            ...
            root.child(Containers.horizontalFlow(Sizing.fill(100), Sizing.fixed(30)).<FlowLayout>configure(container -> {
